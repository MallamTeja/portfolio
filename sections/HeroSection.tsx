...
import tejaMallam from "../public/tejamallam-illustration.webp";
    ...
    >
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="mt-2 my-4 md:mb-8">
          <p className="mb-1">
            I'm a Computer Science undergrad at MLR Institute of Technology with a passion for full-stack development and data analysis.
          </p>
          <p>
            Currently exploring the MERN stack and diving deep into data structures and algorithms. I love building tech with intent and learning something new every day.
          </p>
        </div>
