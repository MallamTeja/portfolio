...
const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
      <span
        aria-hidden="true"
        className="bg-text absolute -top-36 rotate-12 text-gray-100 dark:text-[#1f2e3f] text-9xl tracking-wide font-bold select-none pointer-events-none text-center z-0"
      >
